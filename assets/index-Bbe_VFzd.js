  ...
  tl = V({}, Zt, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== pt &&
            (pt && e.type === "mousemove"
              ? ((Cl = e.screenX - pt.screenX), (Nl = e.screenY - pt.screenY))
              : (Nl = Cl = 0),
            (pt = e)),
          Cl);
    },
...
function hn() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), xs(Zo, hn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function ta(e) {
  ...
  function w(f, a, d, v) {
    ...
    if (N === d.length) return t(f, C), F && gn(f, N), E;
    if (C === null) {
      for (; N < d.length; N++)
        (C = m(f, d[N], v)),
          C !== null &&
            ((a = o(C, a, N)), _ === null ? (E = C) : (_.sibling = C), (_ = C));
      return F && gn(f, N), E;
    }
  ...
  function k(f, a, d, v) {
    ...
    for (
      var _ = (E = null), C = a, N = (a = 0), H = null, L = d.next();
      C !== null && !L.done;
      N++, L = d.next()
    ) {
      C.index > N ? ((H = C), (C = null)) : (H = C.sibling);
    ...
    if (L.done) return t(f, C), F && gn(f, N), E;
    if (C === null) {
...
function Sa(e, n, t) {
  return Pn & 21
    ? (Me(t, n) || ((t = Ns()), (A.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function _o(e, n, t, r) {
  ...
  typeof o == "object" && o !== null
    ? (l.context = _e(o))
    : ((o = de(n) ? Cn : le.current), (l.context = qn(e, o))),
...
function Ti(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Nr(e, n), Na(n, t, r), _o(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
ys = Cu;
gs = Tn;
var zd = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, hs, vs, Cu] },
  vt = {
...
const Rd = () =>
    U.jsxs("nav", {
      className: "navbar",
      children: [
        U.jsx("h1", { id: "title", children: "TO" }),
        U.jsx("h1", { id: "title-with", children: "DO" }),
        U.jsx("div", {
          className: "tick-mark",
          children: U.jsx("i", { className: "fa-solid fa-check" }),
        }),
      ],
    }),
  Od = () =>
  ...
  Md = () => {
    const [e, n] = Lt.useState(""),
      [t, r] = Lt.useState(0),
      l = (i) => {
        (i.value = i.target.value), n(i.value);
      },
      o = () => {
        let i = document.querySelectorAll(".Complete-btn");
        i[t].innerHTML = "<i class='fa-solid fa-check icon-color'></i>";
        let s = document.querySelectorAll(".showTask");
        (s[t].style.color = "rgba(0, 0, 0, 0.527)"),
          (s[t].style.textDecoration = "line-through");
      },
      u = () => {
        let i = document.createElement("li"),
          s = document.createElement("button");
        (s.className = "Complete-btn"), r(t + 1), (i.value = t);
        let c = document.createTextNode(e);
        i.appendChild(c),
          i.prepend(s),
          document.getElementById("n_tasks").appendChild(i),
          i.classList.add("showTask"),
          (s.value = t),
          s.addEventListener("click", o),
          t === 5 && document.getElementById("n_tasks").classList.add("hide");
      };
      ...
      children: [
        U.jsxs("div", {
          ...
          children: [
            ...
            U.jsx("button", { onClick: u, id: "add", children: "ADD" }),
          ],
        }),
        U.jsx("div", {
          className: "Todo-list",
          children: U.jsx("div", {
            className: "Todo-list-works",
            children: U.jsx("ul", {
              id: "tasks",
              children: U.jsx("div", { id: "n_tasks" }),
            }),
          }),
        }),
      ],
...
function Dd() {
  return U.jsxs(U.Fragment, {
    children: [U.jsx(Rd, {}), U.jsx(Od, {}), U.jsx(Md, {})],
  });
}
Ql.createRoot(document.getElementById("root")).render(
  U.jsx(gc.StrictMode, { children: U.jsx(Dd, {}) })
);
